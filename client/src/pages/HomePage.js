    ...
    <Layout>
      <div>
        ...
        <nav className="quick-nav">
          <ul>
            <li><Link to="/upload" className="quick-nav-button">Upload</Link></li>
            <li><Link to="/build" className="quick-nav-button">Build</Link></li>
            <li><Link to="/daily" className="quick-nav-button">Pool of the Day</Link></li>
          </ul>
        </nav>
          ...
          <div className="featured-sets">
            <div className="set-card">
              ...
              <div className="set-info">
                ...
                <p>Return to the world of Tarkir with dragons and powerful khans.</p>
              </div>
            </div>
            ...
            {pools.length > 0 ? (
              pools.map(pool => (
                <div key={pool._id} className="pool-item">
                  ...
                  <Link to={`/build/${pool._id}`} className="view-pool-link">View/Edit</Link>
                </div>
              ))
            ) : (

...
export const updatePool = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ success:true, message: 'Pool updated successfully', data: updatedPool});
    } catch (error) {
...
export const deletePool = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ success:true, message: 'Pool deleted successfully', data: pool});
    } catch (error) {
